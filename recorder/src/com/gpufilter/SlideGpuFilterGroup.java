...
import com.gpufilter.helper.MagicFilterFactory;
import com.gpufilter.helper.MagicFilterType;
...
public class SlideGpuFilterGroup {
    ...
    public SlideGpuFilterGroup() {
        initFilter();
        scroller = new Scroller(RecordApplication.getInstance());
    }
