...
public class MagicHudsonFilter extends GPUImageFilter {
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(RecordApplication.getInstance(), "filter/hudsonbackground.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(RecordApplication.getInstance(), "filter/overlaymap.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(RecordApplication.getInstance(), "filter/hudsonmap.png");
		    }
	    });
	}
}
