...
public class MagicHefeFilter extends GPUImageFilter {
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(RecordApplication.getInstance(), "filter/edgeburn.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(RecordApplication.getInstance(), "filter/hefemap.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(RecordApplication.getInstance(), "filter/hefemetal.png");
				inputTextureHandles[3] = OpenGlUtils.loadTexture(RecordApplication.getInstance(), "filter/hefesoftlight.png");
		    }
	    });
	}
}
