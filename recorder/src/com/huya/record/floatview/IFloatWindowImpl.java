...
public class IFloatWindowImpl extends IFloatWindow {
    ...
    private FloatView.ViewLifeListener mLifeListener;
    ...
    private static IFloatWindowImpl instance;

    public static IFloatWindowImpl getInstance() {
        if (instance != null) {
            return instance;
        }
        return null;
    ...
    IFloatWindowImpl(FloatWindow.B b, View.OnClickListener onClickListener, FloatView.ViewLifeListener lifeListener, String tag) {
        instance = this;
        mB = b;
        ...
        if (mB.mMoveType == MoveType.fixed) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N_MR1) {
                mFloatView = new FloatPhone(b.mApplicationContext, tag);
            } else {
        ...
        mFloatView.setView(mB.mView, FloatView.TYPE_OPERATOR);
        mFloatView.setViewLifeListener(mLifeListener);
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        switch (event.getAction()) {
                            ...
                            case MotionEvent.ACTION_MOVE:
                                if (dragMode || System.currentTimeMillis() - downTime > diffTime) {
                                    dragMode = true;
