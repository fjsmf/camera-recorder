...
import com.filter.AFilter;
import com.filter.GroupFilter;
import com.filter.NoFilter;
import com.filter.ProcessFilter;
import com.gpufilter.filter.MagicBeautyFilter;
import com.utils.EasyGlUtils;
import com.utils.MatrixUtils;
...
//        showFilter.setTextureId(textureID);
    ...
    public void onSurfaceChanged(GL10 gl10, int i, int i1) {
        Log.i("nadiee", "CameraDrawer-onSurfaceChanged()");
        width = i;
        height = i1;
        //清除遗留的
...
//        mAfFilter.setTextureId(mSlideFilterGroup.getOutputTexture());
    ...
    public void oConfigurationChanged() {
        Log.i("nadiee", "CameraDrawer-onConfigurationChanged()");
        drawFilter.setSize(mPreviewWidth,mPreviewHeight);
        //清除遗留的
        GLES20.glDeleteFramebuffers(1, fFrame, 0);
        GLES20.glDeleteTextures(1, fTexture, 0);
